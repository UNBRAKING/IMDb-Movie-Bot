...
BOT_TOKEN = environ['7557160300:AAF5SwtYBBnpByOzJCURGzJ0Qs2Xrd1tXCs']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('5606990991', '').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('-1001899588945', '0').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
ADMINS.append(1684438752)
auth_channel = environ.get('-1002490446965')
auth_grp = environ.get('-1002027080606')
...
# Others
LOG_CHANNEL = int(environ.get('-1002349193496', 0))
